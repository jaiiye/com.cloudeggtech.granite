...
public class DeployPlanReader implements IDeployPlanReader {
	...
	private Global readGlobalSection(Properties properties) {
		...
		if (sSessionDurationTime != null) {
			try {
				...
				throw new IllegalArgumentException("Property 'session-duration-time' in global section must be an integer.");
			}
		}
