...
import com.cloudeggtech.granite.cluster.node.mgtnode.deploying.pack.config.ConfigFiles;
...
public class AbilityStreamConfigurator implements IPackConfigurator {
	...
	protected void configureTlsAndSasl(IConfig config, Properties properties) {
		...
		if (properties.getProperty("sasl.supported.mechanisms", "DIGEST-MD5") != null) {
