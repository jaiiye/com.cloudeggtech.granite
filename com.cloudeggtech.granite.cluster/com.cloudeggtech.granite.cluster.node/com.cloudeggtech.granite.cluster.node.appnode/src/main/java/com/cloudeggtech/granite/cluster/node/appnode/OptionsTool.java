package com.cloudeggtech.granite.cluster.node.appnode;


import java.util.Map;

import com.cloudeggtech.granite.cluster.node.commons.options.AbstractOptionsTool;
import com.cloudeggtech.granite.cluster.node.commons.options.OptionRule;
import com.cloudeggtech.granite.cluster.node.commons.options.OptionRule.DataType;
import com.cloudeggtech.granite.cluster.node.commons.options.OptionRule.Range;
...
public class OptionsTool extends AbstractOptionsTool<Options> {
	...
	protected void printUsage() {
		System.out.println("Usage: java com.cloudeggtech.granite.cluster.appnode.Main [OPTIONS]");
