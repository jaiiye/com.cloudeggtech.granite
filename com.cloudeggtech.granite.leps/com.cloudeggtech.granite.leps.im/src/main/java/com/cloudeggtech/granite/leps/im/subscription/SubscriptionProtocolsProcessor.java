...
import com.cloudeggtech.granite.leps.im.roster.RosterOperator;
...
public class SubscriptionProtocolsProcessor implements IApplicationConfigurationAware,
		IPersistentObjectFactoryAware, IConfigurationAware {
	...
	private void saveNotification(String notificationId, String user, String contact, SubscriptionType subscriptionType, String additionalMessage) {
		...
		if (existed != null) {
			...
			LepSubscriptionNotification notification = persistentObjectFactory.create(LepSubscriptionNotification.class);
