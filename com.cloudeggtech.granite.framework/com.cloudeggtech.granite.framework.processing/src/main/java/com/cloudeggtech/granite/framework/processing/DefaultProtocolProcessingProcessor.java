...
import com.cloudeggtech.granite.framework.core.event.EventService;
...
import com.cloudeggtech.granite.framework.core.session.ValueWrapper;

import net.sf.cglib.proxy.UndeclaredThrowableException;

@Component("default.protocol.processing.processor")
public class DefaultProtocolProcessingProcessor implements com.cloudeggtech.granite.framework.core.integration.IMessageProcessor,
	...
	protected com.cloudeggtech.granite.framework.processing.IMessageProcessor messageProcessor;
	...
	private void outputRuntimeExceptionError(IConnectionContext context, RuntimeException e, Object message) {
		if (message instanceof Stanza) {
			...
			context.write(new com.cloudeggtech.basalt.protocol.core.stream.error.InternalServerError(CommonUtils.getInternalServerErrorMessage(e)));
			context.close();
		}
	...
	private StanzaError createStanzaError(IConnectionContext context, RuntimeException e, Object message) {
		...
		StanzaError error = new com.cloudeggtech.basalt.protocol.core.stanza.error.InternalServerError(CommonUtils.getInternalServerErrorMessage(e));
	...
	public void setMessageProcessor(com.cloudeggtech.granite.framework.processing.IMessageProcessor messageProcessor) {
