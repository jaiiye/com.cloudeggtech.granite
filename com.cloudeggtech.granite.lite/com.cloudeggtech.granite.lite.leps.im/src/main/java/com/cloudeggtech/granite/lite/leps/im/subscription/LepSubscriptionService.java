...
import com.cloudeggtech.granite.leps.im.subscription.ILepSubscriptionService;

@Transactional
@Component("subscriptionService")
public class LepSubscriptionService implements ILepSubscriptionService, IPersistentObjectFactoryAware {
	@Autowired
