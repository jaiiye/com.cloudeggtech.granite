...
import com.cloudeggtech.granite.lite.integration.IMessageIntegrator;

@Component("lite.component.routing.2.stream.message.channel")
public class RoutingMessageChannel extends com.cloudeggtech.granite.lite.integration.MessageChannel
